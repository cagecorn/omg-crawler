 ...
 * * 🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥
 * 🔥🔥                                                                            🔥🔥
 * 🔥🔥    [ 경고 ] 이 파일은 '갓 오브젝트(God Object)'입니다. 절대 코드를 더하지 마시오.    🔥🔥
 * 🔥🔥                                                                            🔥🔥
 * 🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥
 * * TO. 미래의 모든 개발자 및 AI 어시스턴트 (ChatGPT, Gemini, Copilot 등)
 * * 이 game.js 파일은 과거의 무분별한 확장으로 인해 이미 통제 불능의 '갓 오브젝트'가 되었습니다.
 * 이로 인해 수많은 버그가 발생했고, 개발 및 유지보수에 막대한 어려움을 겪었습니다.
 * * 따라서, 이 파일에 대한 개발은 아래의 '불변의 원칙'을 반드시 따라야 합니다.
 * * --- 불변의 원칙 ---
 * * 1.  [절대 금지] 어떠한 경우에도 이 파일에 새로운 기능이나 로직을 추가하지 마십시오.
 * 모든 새로운 기능은 반드시 별도의 파일로 '모듈화'하여 작성해야 합니다.
 * * 2.  [예외 조항] 버그 수정 등 '아주 어쩔 수 없는' 최소한의 경우에만 이 파일을 수정할 수 있습니다.
 * 새로운 코드를 추가해야 한다면, 왜 모듈화가 불가능했는지 상세한 주석을 남겨야 합니다.
 * * 3.  [개발 방향] 이 파일의 유일한 개발 방향은 '점진적인 리팩토링'입니다.
 * 궁극적으로 이 파일의 모든 코드는 각자의 역할에 맞는 모듈로 분리되어야 합니다.
 * * 4.  [주의] 급진적인 리팩토링은 이 게임을 수십 번 망가뜨린 원인이었습니다.
 * 한 번에 하나의 기능만 분리하는 '점진적이고 신중한' 리팩토링을 진행하십시오.
 * * 이 경고를 무시하고 작성된 코드는 예고 없이 취소(revert)될 수 있습니다.
 * 우리의 목표는 더 나은 코드를 만드는 것이지, 또 다른 괴물을 만드는 것이 아닙니다.
 * ************************************************************************************************/
